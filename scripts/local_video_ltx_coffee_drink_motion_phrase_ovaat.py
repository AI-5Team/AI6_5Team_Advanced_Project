...
DEFAULT_IMAGE = REPO_ROOT / "docs" / "sample" / "음식사진샘플(커피).jpg"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs" / "experiments" / "artifacts" / "exp-79-local-ltx-coffee-drink-motion-phrase-ovaat"
DEFAULT_NEGATIVE_PROMPT = "worst quality, blurry, jittery, distorted, warped, overexposed, text, watermark"
DEFAULT_SEED = 7
BASELINE_PROMPT = "iced coffee, bright tabletop lighting, realistic drink commercial motion, static close-up, minimal camera movement"
VARIANT_PROMPT = "iced coffee, bright tabletop lighting, still life beverage shot, static close-up, minimal camera movement"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare coffee drink motion phrase vs still-life phrase on local LTX.")
    ...
    summary = {
        ...
        "validation_type": "coffee_drink_motion_phrase_ovaat",
