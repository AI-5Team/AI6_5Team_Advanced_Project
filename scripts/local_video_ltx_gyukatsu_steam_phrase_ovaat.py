...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs" / "experiments" / "artifacts" / "exp-76-local-ltx-gyukatsu-steam-phrase-ovaat"
DEFAULT_NEGATIVE_PROMPT = "worst quality, blurry, jittery, distorted, warped, overexposed, text, watermark"
DEFAULT_SEED = 7
BASELINE_PROMPT = "crispy gyukatsu, bright tabletop lighting, strong steam cloud, realistic food motion, static close-up, minimal camera movement"
VARIANT_PROMPT = "crispy gyukatsu, bright tabletop lighting, realistic food motion, static close-up, minimal camera movement"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare gyukatsu tray baseline prompt vs no-steam variant on local LTX.")
    ...
    summary = {
        "experiment_id": "EXP-76",
        "validation_type": "gyukatsu_steam_phrase_ovaat",
