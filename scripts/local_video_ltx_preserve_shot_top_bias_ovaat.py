...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs" / "experiments" / "artifacts" / "exp-67-local-ltx-preserve-shot-top-bias-ovaat"
DEFAULT_IMAGES = [
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare contain_blur vs cover_top for preserve-shot photos in local LTX.")
    ...
    summary = {
        "experiment_id": "EXP-67",
        "validation_type": "preserve_shot_top_bias_ovaat",
        "seed": DEFAULT_SEED,
