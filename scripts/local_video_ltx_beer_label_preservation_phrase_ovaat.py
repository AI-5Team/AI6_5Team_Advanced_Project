...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs" / "experiments" / "artifacts" / "exp-81-local-ltx-beer-label-preservation-phrase-ovaat"
...
VARIANT_PROMPT = "beer bottle and lager glass, bright tabletop lighting, still life beverage shot, clear bottle label, readable paper label shape, static close-up, minimal camera movement"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare beer baseline vs label preservation phrase on local LTX.")
    ...
    variant = run_variant(args.output_dir / "variant-label-preservation", VARIANT_PROMPT, args.offline)
    summary = {
        "experiment_id": "EXP-81",
        "validation_type": "beer_label_preservation_phrase_ovaat",
